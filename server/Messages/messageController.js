...
var accountSid = 'your account sid from twilio'; //NEED TO GET ACCOUNT SID
var authToken = 'your auth token from twilio'; //NEED TO GET AUTH TOKEN
...
var messageController = {
 ...
 sendText: function(){
   client.messages.create({
     to: '+your number from twilio',   //NEED TO SET UP AUTHORIZED NUMBERS
